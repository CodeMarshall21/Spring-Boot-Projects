...
//        System.out.println("User Name: "+user.getName()+", User Email: "+user.getEmail());
    ...
    public UserEntity updateUser(@PathVariable Long id, @RequestBody UserEntity user){
        UserEntity updatedUser = userRepository.findById(id).orElseThrow(()-> new ResourceNotFoundException("User not found with ID: "+id));
    ...
    public ResponseEntity<?> deleteUser(@PathVariable Long id){
        UserEntity deleteUser = userRepository.findById(id).orElseThrow(()-> new ResourceNotFoundException("User Not Found with ID: "+id));
